...
| `showMeasureAngleButton`     | `boolean`                          | `false`           | Render an angle-icon toggle in `<ViewerToolbar>` for the angle tool                                                                                                 |
